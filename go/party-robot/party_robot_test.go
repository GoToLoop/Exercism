...
func TestAssignTable(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want:        "Welcome to my party, Chihiro!\nYou have been assigned to table 022. Your table is " +
								"straight ahead, exactly 9.2 meters from here.\nYou will be sitting next to Akachi Chikondi.",
		},
		{
			...
			distance:    23.470103,
			seatmate:    "Renée",
			want:        "Welcome to my party, Xuân Jing!\nYou have been assigned to table 004. Your table is by " +
								"the façade, exactly 23.5 meters from here.\nYou will be sitting next to Renée.",
		},
		{
			...
			distance:    100.0,
			seatmate:    "Chioma",
			want:        "Welcome to my party, Paula!\nYou have been assigned to table 101. Your table is on the " +
								"right, exactly 100.0 meters from here.\nYou will be sitting next to Chioma.",
		},
	}
	for _, tt := range tests {
		t.Run(tt.description, func(t *testing.T) {
